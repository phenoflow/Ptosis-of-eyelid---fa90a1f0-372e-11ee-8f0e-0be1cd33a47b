...
(async () => {
  ...
  await fs.writeFile("ptosis-of-eyelid-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("ptosis-of-eyelid-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
